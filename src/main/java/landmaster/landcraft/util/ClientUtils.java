...
public class ClientUtils {
	public static void drawBeam(VertexBuffer buffer, Vec3d S, Vec3d E, Vec3d P, float width) {
		...
		drawQuad(buffer, p1, p3, p4, p2);
	}
	
	private static void drawQuad(VertexBuffer buffer, Vec3d p1, Vec3d p2, Vec3d p3, Vec3d p4) {
		int brightness = 240;
